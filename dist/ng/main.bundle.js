...
var InstallerService = (function () {
    ...
    InstallerService.prototype.installPackages = function (packages) {
        var _this = this;
        var subject = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["Subject"](), res = packages.reduce(function (t, c) { return t
            .then(function () {
            if (!c.url) {
                // spinner in 2sxc color
                console.log("fail", c);
                return Promise.resolve();
            }
            subject.next(c);
            return _this.http.get("app-sys/installer/installpackage?packageUrl=" + c.url).toPromise();
        }); }, Promise.resolve())
            .then(function () { return subject.complete(); })
            .catch(function (e) { return subject.error(e); });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_app_core_module_api_service__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_template_picker_template_filter_pipe__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_core_2sxc_service__ = __webpack_require__(38);
...
var TemplatePickerComponent = (function () {
    function TemplatePickerComponent(api, route, templateFilter, sxc, appRef) {
        var _this = this;
        this.api = api;
        this.route = route;
        ...
        this.updateAppSubject
            ...
            var app = _a.app, preview = _a.preview;
                ...
                if (app.supportsAjaxReload)
                    return _this.frame.sxc.manage.contentBlock.reloadAndReInitialize(true, true)
                        ...
                        (function () {
                            ...
                            _this.appRef.tick();
                            _this.updatingApp = false;
                        });
                    });
                if (preview)
                    return _this.frame.sxc.manage.contentBlock.reloadNoLivePreview("<p class=\"no-live-preview-available\">The app <b>" + app.name + "</b> does not have a live preview. Please click on it to see it in action!</p>")
                        .then(function () {
                        _this.loading = false;
                        _this.frame.scrollToTarget();
                        _this.appRef.tick();
        ...
        this.updateTemplateSubject
            .debounceTime(400)
            .subscribe(function (_a) {
            var template = _a.template, preview = _a.preview;
            if (!preview) {
                _this.loadingTemplates = false;
                _this.template = template;
                _this.updatingContentType = false;
                _this.appRef.tick();
            }
            ...
            if (preview)
                return _this.frame.sxc.manage.contentBlock.reloadNoLivePreview("<p class=\"no-live-preview-available\">The content type <b>" + template.Name + "</b> does not have a live preview. Please click on it to see it in action!</p>")
                    .then(function () {
                    _this.loading = false;
                    _this.frame.scrollToTarget();
                    _this.appRef.tick();
    ...
    TemplatePickerComponent.prototype.updateContentType = function (contentType, preview, keepTemplate) {
    ...
    TemplatePickerComponent.prototype.reloadApp = function () {
        this.updateApp(this.app, true);
    };
    TemplatePickerComponent.prototype.updateApp = function (app, preview) {
        if (preview === void 0) { preview = false; }
        if (!preview) {
            this.app = app;
            if (app.supportsAjaxReload)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_component__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_template_picker_template_picker_module__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_template_picker_template_picker_component__ = __webpack_require__(109);
...
var appRoutes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_5_app_template_picker_template_picker_component__["a" /* TemplatePickerComponent */]
    },
    {
        path: 'index.html',
        component: __WEBPACK_IMPORTED_MODULE_5_app_template_picker_template_picker_component__["a" /* TemplatePickerComponent */]
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4_app_template_picker_template_picker_module__["a" /* TemplatePickerModule */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_core_module_api_service__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_core_2sxc_service__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_http__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_core_http_interceptor_service_provider__ = __webpack_require__(200);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__http_interceptor_service__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_app_core_2sxc_service__ = __webpack_require__(38);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_app_installer_installer_service__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_app_core_module_api_service__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__installer_component__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_installer_installer_service__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser_animations__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__template_picker_component__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__template_filter_pipe__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_app_core_core_module__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__content_type_filter_pipe__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_flex_layout__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_app_installer_installer_module__ = __webpack_require__(203);
...
TemplatePickerModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_10_app_installer_installer_module__["a" /* InstallerModule */]
        ],
        providers: [

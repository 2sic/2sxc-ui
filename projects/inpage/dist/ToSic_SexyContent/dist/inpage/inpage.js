...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__config_formats_toolbar_wip__ = __webpack_require__(111);
...
var RuleManager = /** @class */ (function (_super) {
    ...
    RuleManager.prototype.getSystem = function (name) {
        var found = this.rules.find(function (r) { return r.operation === __WEBPACK_IMPORTED_MODULE_0____["Operations"].system && r.id === name; });
        return found;
    };

...
describe('Toolbar test suite', function() {
  ...
  it('3 mock standard toolbar', function() {
    ...
    const cnt = new ContextComplete(editContext);
    cnt.toolbar = expandToolbarConfig(cnt, toolbarData, toolbarSettings);

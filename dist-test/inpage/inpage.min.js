...
(function () {
    ...
    cbm.persistTemplate = function (sxc, templateId, forceCreate) {
        var manage = sxc.manage, contentGroup = manage._editContext.ContentGroup, isPreview = $2sxc._toolbarManager.isDisabled(sxc), 
...
(function () {
    var resizeInterval = 200, scrollTopOffset = 80, resizeWatcher = null, diagShowClass = "dia-select", isFullscreen = false;
    /**
    ...
    function extendIFrameWithSxcState(iFrame) {
        var hiddenSxc = null, cbApi = $2sxc._contentBlock, tagModule = null;
        /**
...
(function () {
    ...
    $2sxc._toolbarManager.generateButtonHtml = function (sxc, actDef, groupIndex) {
        ...
        var showClasses = "group-" + groupIndex, classesList = (actDef.classes || "").split(","), box = $("<div/>"), symbol = $("<i class=\"" + actDef.icon + "\" aria-hidden=\"true\"></i>"), onclick = actDef.disabled
            ? ""

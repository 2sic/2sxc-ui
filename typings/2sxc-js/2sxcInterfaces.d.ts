...
interface SxcWebApi {
     ...
     * @returns {} 
     */
    get(settingsOrUrl, params?, data?, preventAutoFail?): any,
    post(settings, params?, data?, preventAutoFail?): any,
    delete(settings, params?, data?, preventAutoFail?): any,
    put(settings, params?, data?, preventAutoFail?): any,
}
